...
public class MainController {
  ...
  public @ResponseBody String editUser(@RequestParam String nombre, @RequestParam String raza,
      @RequestParam String propietario,
  ...
  public @ResponseBody List<Map<String, Object>> getReport() {
    String sql = "SELECT CONCAT(nombre, '(nombre) ==> (Raza)', raza) as MIS_USUARIOS FROM user;";
